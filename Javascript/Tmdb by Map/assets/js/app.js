...
const movieContainer = document.getElementById("containerMovie");
...
if(movies.vote_average>=0 && movies.vote_average <=5)
 {
	voteAvg="bg-danger";
 }
else if(movies.vote_average>=5 && movies.vote_average <=7)
 {
	voteAvg="bg-warning";
 }
else{
					...
					<div class = "col-md-3 mb-4">
						<div class = "card ">
							<figure class="movieCard">
								<img class = "movieImg"
								src ="https://image.tmdb.org/t/p/w1280/${movies.backdrop_path}" alt="">
								<figcaption>
